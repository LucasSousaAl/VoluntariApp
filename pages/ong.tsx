  ...
  return (
    <div className="page page--cream">
      ...
      <div className="container container--wide">
        {/* Header */}
        <div
          className="card--hero mb-28 flex items-center justify-between"
          style={{ borderRadius: "var(--radius)", padding: 32 }}
        >
          <div className="ong-header-content">
            <div className="ong-header-avatar">{ongData.nome?.charAt(0)}</div>
            <div style={{ flex: 1 }}>
          ...
          <div className="flex gap-20">
            {[
              {
                num: ongVagas.filter((v) => v.status === "Ativa").length,
                label: "Vagas ativas",
              },
