        ...
        if (res.ok && data.length > 0) {
          ...
          setFetchedVaga({
            ...
            ongSince: t.ong_since
              ? new Date(t.ong_since).getFullYear().toString()
              : "2023",
          });
        }
      } catch (err) {
  ...
  const handleApply = async () => {
    ...
    try {
      const res = await fetch("/api/v1/trabalho/apply", {
        ...
        body: JSON.stringify({ trabalho_id: vaga.id }),
      });
      const data = await res.json();
      if (res.ok) {
          ...
          <div>
            ...
            >
              <div className="flex items-center gap-10 mb-16">
                ...
                <div>
                  ...
                  <div style={{ fontSize: 12, color: "var(--green-300)" }}>
                    ONG verificada ✓
                  </div>
                </div>
              </div>
              <h1
                ...
                style={{ fontSize: 34, lineHeight: 1.15, marginBottom: 16 }}
              >
                {vaga.title}
              </h1>
            ...
            <div className="info-grid">
              {[
                {
                  label: "Vagas Abertas",
                  value: `${vaga.totalSlots - vaga.filledSlots} restantes`,
                },
                {
                  label: "Carga Horária",
                  value: `${vaga.hoursPerWeek} / semana`,
                },
            ...
            {/* Description */}
            <div className="mb-28">
              <h3 className="heading-serif mb-12" style={{ fontSize: 18 }}>
                Sobre a vaga
              </h3>
              <p
                style={{
                ...
                >
                  {vaga.requirements.map((req, i) => (
                    <li
                      ...
                      style={{ fontSize: 15, color: "var(--gray-600)" }}
                    >
                      <span
          ...
          <div className="vaga-sidebar">
            ...
            >
              ...
              <div className="text-muted mb-24" style={{ fontSize: 13 }}>
                {vaga.totalSlots - vaga.filledSlots} vagas disponíveis ·
                Resposta em até 48h
              </div>
            ...
            <div className="card" style={{ padding: 22 }}>
              <div className="flex items-center gap-12 mb-12">
                ...
                <div>
                  <div className="heading-serif" style={{ fontSize: 15 }}>
                    {vaga.ong}
                  </div>
